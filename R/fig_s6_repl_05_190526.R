...
q75 <- function(x) quantile(x, .75, na.rm = T) + 0.001 * mean(x, na.rm = T)
...
ggsave(plot = p, filename = paste0('fig_s6_05_', date, '.png'),
...
writexl::write_xlsx(res_fig_3, paste0('res_fig_s6_05_', date, '.xlsx'))
